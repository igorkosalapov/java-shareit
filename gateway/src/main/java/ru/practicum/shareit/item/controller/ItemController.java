...
public class ItemController {
    ...
    @PatchMapping("/{itemId}")
    public ResponseEntity<Object> update(@RequestHeader(BaseClient.USER_HEADER) @Positive long userId,
    ...
    @GetMapping
    public ResponseEntity<Object> getOwnerItems(@RequestHeader(BaseClient.USER_HEADER) @Positive long userId,
    ...
    @GetMapping("/search")
    public ResponseEntity<Object> search(@RequestHeader(BaseClient.USER_HEADER) @Positive long userId,
